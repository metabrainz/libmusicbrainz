...
Queries queries[] = 
{
    { "GetCDInfoFromCDIndexId", GetCDInfoFromCDIndexID, 
      1, "CD Index ID", "", "", "" }, 
    { "FindArtist",             FindArtistByName,
      1, "Artist Name", "", "", "" },
    { "FindTrack",              FindTrackByName,
      3, "Track Name", "Album Name", "Artist Name", "" },
    { "FindAlbumsByArtist",     FindAlbumsByArtistName,
      1, "Artist Name", "", "", "" },
    { "FindAlbum",              FindAlbumByName,
      1, "Album Name", "", "", "" },
    { "FindDistinctGUID",       FindDistinctGUID,
      2, "Track Name", "Artist Name", "", "" },
    { "GetArtist",              GetArtistById ,
      1, "Artist ID", "", "", "" },
    { "GetAlbum",               GetAlbumById ,
      1, "Album ID", "", "", "" },
    { "GetAlbumsByArtist",      GetAlbumsByArtistId ,
      1, "Artist ID", "", "", "" },
    { "GetTrack",               GetTrackById ,
      1, "Track ID", "", "", "" },
    { "GetLyrics",              GetLyricsById ,
      1, "Track ID", "", "", "" },
    { "GetCDInfo",              GetCDInfo ,
      0, "", "", "", "" },
    { "GetCDTOC",               GetCDTOC ,
      0, "", "", "", "" },
    { "AssociateCD",            AssociateCD ,
      0, "", "", "", "" },
    { "\0",                     "\0", 0, "", "", "", "" }
}; 
